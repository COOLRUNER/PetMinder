...
{
    /// <inheritdoc />
    public partial class AddFinalPendingFeatures : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
        //     migrationBuilder.Sql(@"
        // CREATE TYPE transaction_type AS ENUM ('booking', 'donation', 'adjustment', 'verification_reward');
        //  ");
        //     migrationBuilder.Sql(@"
        // CREATE TYPE address_type AS ENUM ('primary', 'secondary', 'other');
        // ");
    ...
    ");
        ...
        // 2. Create the new address_type enum
        migrationBuilder.Sql(@"
        CREATE TYPE address_type AS ENUM ('primary', 'secondary', 'other');
    ");

        // 3. Add the 'expiration' value to the transaction_type enum
        migrationBuilder.Sql(@"
        ALTER TYPE transaction_type ADD VALUE 'expiration';
    ");
